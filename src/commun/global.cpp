...
namespace GotoPP
{
	...
	Symbole * symboleEtc; //pseudo-symbole, utilis� pour la d�finition de type
	Symbole * symboleDebutParams; //pseudo-symbole, utilis� pour la d�finition de type
	...
	carac NomTypeAutre[][32]=
	{
		...
		_T("ETIQUETTE"),
		_T("DEBUTPARAM"),
		_T("FONCTION"),//Le num�ro d'une fonction C
		_T("TABLEAU"),//Tableau
...
{
	//On supprime le nom de l'ex�cutable
